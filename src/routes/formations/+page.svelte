<main class="flex flex-col gap-10 md:gap-20 mb-20">
	<article
		class="w-10/12  m-auto  flex flex-col items-center gap-10 md:gap-20 md:grid grid-cols-2"
		id=""
	>
		<figure class="">
	...
	<article
		class="w-10/12 md:w-12/12 m-auto flex flex-col items-center gap-10 md:gap-20 md:grid grid-cols-2"
		id=""
	>
		...
		<section class="flex flex-col gap-10 order-2 md:order-1 ">
			...
			<h2 class="text-2xl">Titre formations</h2>
			<p>
				Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
				labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco
				laboris nisi ut aliquip ex ea commodo consequat.
		...
		<div class="flex flex-col md:flex-row gap-5">
			<button class="bg-gray-600"> S'incrire</button>
			<button class="bg-gray-600"> En savoir plus </button>
